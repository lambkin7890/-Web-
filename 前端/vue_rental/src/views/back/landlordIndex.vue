        ...
        <div class="body-area">
            <el-container style="min-height:430px">
                <el-aside width="200px">
                    ...
                    <el-menu default-active="this.$route.path" class="el-menu-vertical-demo" @open="handleOpen"
                        ...
                        <el-submenu index="1">
                            ...
                            <el-menu-item index="" @click="activeIndex=0" :class="{active:activeIndex===0}">短租
                            </el-menu-item>
                            <el-menu-item index="" @click="activeIndex=1" :class="{active:activeIndex===1}">长租
                            </el-menu-item>
                        </el-submenu>
                        ...
                        <el-submenu index="2">
                            ...
                            <el-menu-item index="" @click="activeIndex=3" :class="{active:activeIndex===3}">个人信息
                            </el-menu-item>
                            <el-menu-item index="" @click="activeIndex=4" :class="{active:activeIndex===4}">密码设置
                            </el-menu-item>
                        </el-submenu>
                    </el-menu>
                </el-aside>
                <el-main>
                    ...
                    <AccountInfo v-show="activeIndex===3"></AccountInfo>
                    <Password v-show="activeIndex===4"></Password>
                </el-main>
            </el-container>
        </div>
...
<script>
    import House from "@/components/landlord_center/houseMc.vue";
    import BookOrder from "@/components/landlord_center/BookOrderMC.vue";
    import LongRentHouse from "@/components/landlord_center/LongRentHouseMC.vue";
    import AccountInfo from "@/components/landlord_center/AccountInfoMC.vue";
    import Password from "@/components/landlord_center/PasswordMC.vue";
    export default {
        data() {
            return {
                isCollapse: true,
        ...
        mounted() {
            this.getUserInfo();
            this.menuActive = this.$route.params.menuActive;
        },
        methods: {
...
<style>
    .el-main .main .el-table td,
    .el-main .main .el-table th {
        text-align: center;
    }
...
<style scoped>
    ...
    .navbar-header a.navbar-brand:link {
        font-weight: 500;
    }
    ...
    .g-crt-int-links a:hover,
    .g-crt-int-links a:link,
    .g-crt-int-links a:visited {
