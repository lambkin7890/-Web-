                ...
                <div class="order-box"  v-for="(item,index) in list">
                    ...
                    <div class="order-con clearfix">
                        ...
                        <div class="order-feedback">
                            ...
                            <p v-if="item.status==0" class="feedbackp mgtp30"><a href="javascript:;" class="feedback" @click="toPay(index)">待付款</a></p>
                        </div>
                    </div>
                </div>
            </div>
...
<script>
    export default {
        ...
        methods:{
            ...
            toPay(index){
                localStorage.setItem("orderInfo",JSON.stringify(this.list[index]));
                this.$router.push({
                    name: 'pay'
                })
            },
