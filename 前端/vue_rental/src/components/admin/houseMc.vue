<template>
  <div class="main">
    ...
    <el-table :data="tableData" style="width: 100%;">
      ...
      <el-table-column prop="sn" width="100" label="房源编号"></el-table-column>
      <el-table-column prop="name" width="250" show-overflow-tooltip label="房源名称"></el-table-column>
      ...
      <el-table-column prop="landlordName" label="房东" width="80"></el-table-column>
      ...
      <el-table-column prop="bedNum" label="床位数" width="80"></el-table-column>
      <el-table-column label="实拍" width="80">
        <template slot-scope="scope">
          <span v-show="scope.row.isRealPhoto==0">否</span>
          <span v-show="scope.row.isRealPhoto==1">是</span>
        </template>
      </el-table-column>
      <el-table-column label="可做饭" width="80">
        <template slot-scope="scope">
          <span v-show="scope.row.isCooking==0">否</span>
          <span v-show="scope.row.isCooking==1">是</span>
        </template>
      </el-table-column>
      <el-table-column label="免费停车" width="80">
        <template slot-scope="scope">
          <span v-show="scope.row.isParkFree==0">否</span>
          <span v-show="scope.row.isParkFree==1">是</span>
        </template>
      </el-table-column>
      <el-table-column label="有投影" width="80">
        <template slot-scope="scope">
          <span v-show="scope.row.isProject==0">否</span>
          <span v-show="scope.row.isProject==1">是</span>
        </template>
      </el-table-column>
      ...
      <span>
        <el-form ref="addHouseForm" :rules="rules" :model="addForm" label-width="80px">
          ...
          <el-form-item prop="name" label="房源名称">
            <el-input v-model.trim="addForm.name" maxlength="20" show-word-limit></el-input>
          </el-form-item>
          ...
          <el-form-item prop="introduce" label="房源简介">
            <el-input v-model="addForm.introduce" maxlength="100" show-word-limit></el-input>
          </el-form-item>
          <el-form-item prop="landlordId" label="房东">
            <el-select v-model="addForm.landlordId" style="width:100%" placeholder="-请选择-">
              <el-option v-for="item in landlords" :key="item.id" :label="item.username" :value="item.id">
              </el-option>
            </el-select>
          </el-form-item>
          <el-form-item prop="liveNum" label="可住人数">
            <el-select v-model="addForm.liveNum" style="width:100%" placeholder="-请选择-">
          ...
          <el-form-item prop="bedNum" label="床位数">
            <el-select v-model="addForm.bedNum" style="width:100%" placeholder="-请选择-">
              <el-option value="1"></el-option>
              <el-option value="2"></el-option>
              <el-option value="3"></el-option>
            </el-select>
          ...
          <el-form-item prop="isRealPhoto" label="实拍">
            <el-select v-model="editForm.isRealPhoto" style="width:100%" placeholder="-请选择-">
              <el-option label="是" :value="1"></el-option>
              <el-option label="否" :value="0"></el-option>
            </el-select>
          </el-form-item>
          <el-form-item prop="isCooking" label="可做饭">
            <el-select v-model="editForm.isCooking" style="width:100%" placeholder="-请选择-">
              <el-option label="是" :value="1"></el-option>
              <el-option label="否" :value="0"></el-option>
            </el-select>
          </el-form-item>
          <el-form-item prop="isParkFree" label="免费停车">
            <el-select v-model="editForm.isParkFree" style="width:100%" placeholder="-请选择-">
              <el-option label="是" :value="1"></el-option>
              <el-option label="否" :value="0"></el-option>
            </el-select>
          </el-form-item>
          <el-form-item prop="isProject" label="有投影">
            <el-select v-model="editForm.isProject" style="width:100%" placeholder="-请选择-">
              <el-option label="是" :value="1"></el-option>
              <el-option label="否" :value="0"></el-option>
            </el-select>
          </el-form-item>
    ...
    <el-dialog title="修改房源信息" :visible.sync="dialogEditFormVisible" width="50%" :before-close="handleClose">
      <span>
        <el-form ref="editHouseForm" :rules="rules" :model="editForm" label-width="80px">
          ...
          <el-form-item prop="name" label="房源名称">
            <el-input v-model.trim="editForm.name" maxlength="20" show-word-limit></el-input>
          </el-form-item>
          <el-form-item prop="price" label="房源价格">
          ...
          <el-form-item prop="introduce" label="房源简介">
            <el-input v-model.trim="editForm.introduce" maxlength="100" show-word-limit></el-input>
          </el-form-item>
          <el-form-item prop="landlordId" label="房东">
            <el-select v-model="editForm.landlordId" style="width:100%" placeholder="-请选择-">
              <el-option v-for="item in landlords" :key="item.id" :label="item.username" :value="item.id">
              </el-option>
            </el-select>
          </el-form-item>
          <el-form-item prop="liveNum" label="可住人数">
            <el-select v-model="editForm.liveNum" style="width:100%" placeholder="-请选择-">
              <el-option value="1"></el-option>
              <el-option value="2"></el-option>
              <el-option value="3"></el-option>
              <el-option value="4"></el-option>
          ...
          <el-form-item prop="bedNum" label="床位数">
            <el-select v-model="editForm.bedNum" style="width:100%" placeholder="-请选择-">
              <el-option value="1"></el-option>
              <el-option value="2"></el-option>
              <el-option value="3"></el-option>
            </el-select>
...
<style>
  .house-uploader .el-upload:hover {
    border-color: #409EFF;
  }

  .house-uploader .el-upload .avatar-uploader-icon {
    font-size: 28px;
    color: #8c939d;
    width: 240px;
    height: 140px;
  ...
  .house-uploader .el-upload  .avatar {
    width: 240px;
    height: 140px;
    display: block;
  }
