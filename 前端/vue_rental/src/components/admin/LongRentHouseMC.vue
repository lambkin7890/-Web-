<template>
  <div class="main">
    ...
    <el-table :data="tableData" style="width: 100%">
      ...
      <el-table-column label="整租" width="80">
        <template slot-scope="scope">
          <span v-show="scope.row.isEntire==0">否</span>
          <span v-show="scope.row.isEntire==1">是</span>
        </template>
      </el-table-column>
      <el-table-column label="朝南" width="80">
        <template slot-scope="scope">
          <span v-show="scope.row.isSouth==0">否</span>
          <span v-show="scope.row.isSouth==1">是</span>
        </template>
      </el-table-column>
      <el-table-column label="有电梯" width="80">
        <template slot-scope="scope">
          <span v-show="scope.row.isElevator==0">否</span>
          <span v-show="scope.row.isElevator==1">是</span>
        </template>
      </el-table-column>
    ...
    data() {
      ...
      return {
        ...
        rules: {
          ...
          area: [
            { validator: checkArea, required: true, trigger: 'blur' }
          ],
          bedRoomNum: [
