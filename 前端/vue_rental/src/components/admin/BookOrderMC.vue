<template>
    <div class="main">
        ...
        <!-- 编辑订单模态框 -->
        <el-dialog title="修改订单信息" :visible.sync="dialogEditFormVisible" width="55%" :before-close="handleClose">
            <span>
...
<style>
    .admin-date .el-input__icon.el-range__icon.el-icon-date {
        display: block;
    }

    .admin-date.el-date-editor--daterange.el-input__inner .el-range-input {
        margin-left: 10px;
    }

    .admin-date.el-date-editor--daterange .el-range__close-icon {
        display: none;
    }

    .admin-date.el-date-editor--daterange.el-input__inner {
        width: 300px;
    }
</style>
<style scoped>
