    ...
    <div class="container">
      ...
      <el-form ref="form" label-width="90px">
        ...
        <el-form-item label="用户密码：">
          <el-input type="password" name="password" v-model="password" placeholder="请输入密码" show-password  @keyup.enter.native="userSubmit"></el-input>
        </el-form-item>
        <el-button type="danger" @click="userSubmit">登录</el-button>
      </el-form>
    </div>
  </div>   
</template>
