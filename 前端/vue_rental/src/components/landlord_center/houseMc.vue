<template>
  <div class="main">
    ...
    <el-table :data="tableData" style="width: 100%;">
      ...
      <el-table-column prop="liveNum" label="可住人数" width="80"></el-table-column>
      ...
      <el-table-column prop="bedRoomNum" label="卧室数量" width="80"></el-table-column>
...
<script>
  export default {
    ...
    methods: {
      ...
      addHouse() {
        var that = this;
        this.addForm.landlordId = this.userInfo.id;
          ...
          if (valid) {
            this.$http({
              ...
              if (response.data.type == 'error') {
                ...
                that.getTableData();
                this.$nextTick(()=>{
                  that.$refs.editHouseForm.resetFields();
                  that.imageUrl='';
                })
              }
            })
