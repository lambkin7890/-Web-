...
public class AlipayUtil {
    ...
    static {
        ResourceBundle alipay_config = ResourceBundle.getBundle("alipay/alipay_config");
    ...
    /*public static void main(String[] args) throws AlipayApiException, JsonProcessingException {
        ...
        boolean b=generateAlipayTradeQueryRequest("4d28b7fea6054154a4c45e12386cadcced2");
